...
In order to precisely outline our objectives, we aim to establish a mapping between reaction IDs and two distinct lists of compound IDs, one for substrates and the other for products.
